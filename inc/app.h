...
//函数声明
void read_recommendation(void);                                 //读取推荐文件
...
G_LNode *find_goods_node(G_LinkedList*L,char *name);              //查找商品结点，被函数调用的函数
void delete_goods(char* account);                               //删除商品
void update_goods_info(void);                                   //更新商品信息，链表更新到文件
void submit_goods(char* account);                               //提交商品
void change_goods_price(G_LinkedList *L,char *name, char *owner, int price);    //修改商品价格，被函数调用的函数
void change_goods_number(G_LinkedList *L,char *name, char *owner, int number);  //修改商品数量，被函数调用的函数
...
void update_recommend_info(void);                               //更新推荐信息，链表更新到文件
